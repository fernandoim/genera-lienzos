...
function muestraayuda_genera_lienzo_gradiente_vertical_color() {
  ...
  echo -e "\t genera_lienzo_franjas - Genera un lienzo con un doble degradado vertical de dos colores aleatorios."
  echo ""
  ...
  echo -e "\t \e[1mgenera_lienzo_franjas\e[0m Genera un lienzo con un doble degradado vertical de dos colores aleatorios."
...
function genera_lienzo_doble_gradiente_vertical_color() {
...
genera_lienzo_doble_gradiente_vertical_color $*
