...
function muestraayuda_genera_lienzo_lineas_horizontales() {
  echo -e "\e[1mNOMBRE\e[0m"
  echo -e "\t genera_lienzo_lineas - Genera un lienzo con lineas blancas y negras de un pixel."
  echo ""
...
instruccion="convert -size "$anchura"x1 "$franjas" -append "$ficherosalida
eval $instruccion
...
genera_lienzo_lineas_horizontales $*
